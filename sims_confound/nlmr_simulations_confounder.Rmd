...
```{r}
map2(.x = analyses$exposures, .y = analyses$outcomes, seed = 2023, reps = 11, bux = 0.3, buy = 0, bgux = -0.1, bv= -1,.f = generate_outcome_plots_linear_replicates_confounder)
```

Now, g2

```{r}
map2(.x = analyses$exposures, .y = analyses$outcomes, seed = 2023, reps = 20, bv= 1, g2 = 4,.f = generate_outcome_plots_g2)
...
```{r}
map2(.x = analyses$exposures, .y = analyses$outcomes, seed = 203, reps = 100, bv= 0, g_sd = 0.5, bx = 0,.f = generate_outcome_plots_vQTL)
...
```{r}
map2(.x = analyses$exposures, .y = analyses$outcomes, seed = 203, reps = 20, bv= 0.2, g_sd = 0.5, bx = 0.3,.f = generate_outcome_plots_vQTL)
