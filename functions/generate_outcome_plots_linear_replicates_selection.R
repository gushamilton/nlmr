generate_outcome_plots_linear_replicates_selection <- function(exposure, outcome, seed = "123", reps = 10,
                                                                bux = 0.3,
                                                                buy = 0.3,
                                                                bgux = -0.1,
                                                                bv = 0) {
  ...
  replicate_internally <- function(n_rep) {
    seed = seed + n_rep
    dat <-  sim_mydata_outcomes_selection(n = 650000, seed = seed,
                                           bux = bux,
                                           buy = buy,
                                           bgux = bgux,
                                           bv = bv)
  ...
  make_figures_replicates(d,exposure,outcome,dat,reps, "figures/linear/", paste0("_linear_effect_selection_bux",bux,"_buy",buy,"_bgux",bgux,"_", bv, "_bv")) 
}
