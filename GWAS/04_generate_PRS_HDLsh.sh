...
cd /user/work/fh6520/bmi/HDL

cut -f 1 HDL_whole_genome.tsv > rsid_list_genome.tsv
...
plink2 --bgen initial_chr.bgen --sample $UKBIOBANK_DATA/data.chr1-22_plink.sample --rm-dup exclude-all --score HDL_whole_genome.tsv 1 2 3
